...
module.exports = {
    async up(queryInterface) {
        ...
        if (tableNames.includes("crash_reports")) {
            console.log("Migration already applied: crash_reports table exists.");
            return;
        }
        ...
        console.log("Created crash_reports table with indexes");
    },
};
